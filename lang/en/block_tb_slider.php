...
$string['slider:myaddinstance'] = 'Add a new Leeloo LXP Content Slider block to the My Moodle page';
$string['slider:manage'] = 'Manage Leeloo LXP Content Slider';
$string['header'] = 'Leeloo LXP Content Slider header';
$string['privacy:metadata:block'] = 'Leeloo LXP Content Slider stores some of its data within the block subsystem.';
...
$string['bxslider_h1'] = 'BX Slider Settings';
